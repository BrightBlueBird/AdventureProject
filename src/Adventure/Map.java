 ...
 private Room startRoom;
  ...
  Map() {
   ...
   // Item Hammer = new Item(ConsoleColers.RED + "Hammer", ConsoleColers.PURPLE + "Used as a weapon" + ConsoleColers.RESET);
    ...
    room1.addItem(new Item("Garden Shears", "Used for cutting"));
    room1.addItem(new Item("Shovel","This tool helps for digging"));
    ...
    room6.addItem(new Item("Spell", "This spell is amazing for killing things"));
    ...
    room7.addItem(new Item("Beef", "Hungry? Lets eat some beef"));
    room7.addItem(new Item("Pepsi", "Quench the thirst"));
    ...
    room8.addItem(new Item("Keys", "Unlocks a specific door"));
    room8.addItem(new Item("Doors", "Many doors, oh no!"));
    ...
    room9.addItem(new Item("Hammer", "Used as a weapon"));
