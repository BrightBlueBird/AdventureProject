 ...
 private Room startRoom;
  ...
  Map() {
   ...
   // Item Hammer = new Item(ConsoleColers.RED + "Hammer", ConsoleColers.PURPLE + "Used as a weapon" + ConsoleColers.RESET);
    ...
    room1.addItem(new String(ConsoleColers.RED + "Garden Shears", ConsoleColers.PURPLE + "Used for cutting" + ConsoleColers.RESET));
    room1.addItem(new String(ConsoleColers.RED + "Shovel", ConsoleColers.PURPLE + "This tool helps for digging" + ConsoleColers.RESET));
    ...
    room2.addItem(new String(ConsoleColers.RED + "Garden Shears", ConsoleColers.PURPLE + "Used for cutting" + ConsoleColers.RESET));

    room3.setSouth(room6);
    room3.setWest(room2);
    room3.setRoomDescription("""
        The room is completely dark, however a putrid, almost sweet smell fills your nostrils.""");
    room3.addItem(new String(ConsoleColers.RED + "Light", ConsoleColers.PURPLE + "This spell is nice" + ConsoleColers.RESET));
    ...
    room4.addItem(new String(ConsoleColers.RED + "Shovel", ConsoleColers.PURPLE + "This tool helps for digging" + ConsoleColers.RESET));

    room5.setSouth(room8);
    room5.setRoomDescription("""
        You are in the treasure chamber or something!
        I think this is where you win the game later on.""");
    room5.addItem(new String(ConsoleColers.RED + "Treasure", ConsoleColers.PURPLE + "Oh mama! JACKPOT" + ConsoleColers.RESET));
    ...
    room6.addItem(new String(ConsoleColers.RED + "Spell", ConsoleColers.PURPLE + "This spell is amazing for killing things" + ConsoleColers.RESET));
    ...
    room7.addItem(new String(ConsoleColers.RED + "Beef", ConsoleColers.PURPLE + "Hungry? Lets eat some beef" + ConsoleColers.RESET));
    room7.addItem(new String(ConsoleColers.RED + "Pepsi", ConsoleColers.PURPLE + "Quench the thirst" + ConsoleColers.RESET));
    ...
    room8.addItem(new String(ConsoleColers.RED + "Keys", ConsoleColers.PURPLE + "Unlocks a specific door" + ConsoleColers.RESET));
    room8.addItem(new String(ConsoleColers.RED + "Doors", ConsoleColers.PURPLE + "Many doors, oh no!" + ConsoleColers.RESET));
    ...
    room9.addItem(new String(ConsoleColers.RED + "Hammer", ConsoleColers.PURPLE + "Used as a weapon" + ConsoleColers.RESET));
